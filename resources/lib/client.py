...
def request(url, close=True, redirect=True, proxy=None, post=None, headers=None, mobile=False, limit=None, referer=None, cookie=None, output='', timeout='30'):
    try:
        handlers = []
        ...
        try:
            ...
            if response.code not in [200,301,302]:
                raise Exception()
        except:
            return
